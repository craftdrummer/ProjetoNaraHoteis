-- Script VERSAO: v:1.07.03  - Atualisado em 10 06 2026
-- CARREGAMENTO GERAL DO BANCO - EXECUTA TUDO DE UMA VEZ
...
SHOW VARIABLES LIKE 'secure_file_priv';     -- destrava seguranca para que o banco de dados leia ou exporte arquivos de qualquer pasta do seu computador
...
-- pasta segura: C:/ProgramData\MySQL/MySQL Server 8.0/Uploads/
-- informe o caminho da pasta onde estao os arquivos a serem carregados na sua maquina
LOAD DATA INFILE  'C:/Users/luis.accampora/SENAC-UC2-Projeto/Projeto-NaraHoteis/Unidades auditado.csv'
...
-- LOAD DATA INFILE   'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Tipos de Quarto auditado.csv'
...
-- DELETE FROM funcionarios WHERE id_reserva > 0 ;
